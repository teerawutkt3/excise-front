...
declare var $: any;
@Component({
  selector: 'app-int12020102',
  templateUrl: './int12020102.component.html',
  styleUrls: ['./int12020102.component.css']
})
export class Int12020102Component implements OnInit {

  breadcrumb: BreadCrumb[] = [
    { label: "ตรวจสอบภายใน", route: "#" },
    { label: "บันทึกข้อมูล", route: "#" },
    { label: "ข้อมูลสินทรัพย์ ", route: "#" },
    { label: "ประวัติการซ่อมบารุงรักษาทรัพย์สิน ", route: "#" },
  ];
