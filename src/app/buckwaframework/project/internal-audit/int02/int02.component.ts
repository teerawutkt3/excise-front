...
const URL = {
  SEARCH: AjaxService.CONTEXT_PATH + "ia/int02/filter",
  CANCEL_SEND: "ia/int02/cancel-send-qtn"
}

@Component({
  selector: 'app-int02',
  templateUrl: './int02.component.html',
  styleUrls: ['./int02.component.css']
})
export class Int02Component implements OnInit {
