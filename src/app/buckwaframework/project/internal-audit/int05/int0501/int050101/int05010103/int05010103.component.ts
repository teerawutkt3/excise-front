...
declare var $: any;
@Component({
  selector: 'app-int05010103',
  templateUrl: './int05010103.component.html',
  styleUrls: ['./int05010103.component.css']
})

export class Int05010103Component implements OnInit {
  idProcess: any;
  ...
  ngOnInit() {
    //this.authService.reRenderVersionProgram('INT-05010103');
