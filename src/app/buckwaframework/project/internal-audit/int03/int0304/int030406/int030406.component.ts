...
const URLS = {
  GET_EXPORT: "ia/int03/04/06/year/export",
}

@Component({
  selector: 'app-int030406',
  templateUrl: './int030406.component.html',
  styleUrls: ['./int030406.component.css']
})
export class Int030406Component implements OnInit {
      ...
      columns: [
        {
          ...
          data: "dateTo", className: "text-center"
        }, {
          data: "iaRiskCheckPeriod.longTime", className: "text-center"
        }, {
        ...
        if (data.intCalculateCriteriaVo.codeColor) {
          $(row).find('td:eq(7)').css('background-color', data.intCalculateCriteriaVo.codeColor)
        }
      },
    })
  }
  ...
  getDataList() {
    const URL = "ia/int03/04/06/checkPeriodList"
