...
@Component({
  selector: "int0307",
  templateUrl: "./int0307.component.html",
  styleUrls: ["./int0307.component.css"]
})
export class Int0307Component implements OnInit {
  ...
  dataTable: any
  dataList: any[] = [{ riskFactorsMaster: "", side: "55555", dateFrom: "", dateTo: "", riskUnit: "", infoUsedRiskDesc: "", riskIndicators: "" }]
  ...
  newUpload() {
    ...
    this.ajaxService.doPost(URL, {
      ...
      this.flagData = this.route.snapshot.queryParams["dataEvaluate"]
  ...
  invalidControl(control: string) {
    return this.dataFactorsData.get(control).invalid && (this.dataFactorsData.get(control).touched || this.submitted);
  }
}
