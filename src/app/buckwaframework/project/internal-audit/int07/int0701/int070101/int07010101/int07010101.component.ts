...
import { Int07010101Service } from './int07010101.service';
...
@Component({
  selector: 'app-int07010101',
  templateUrl: './int07010101.component.html',
  styleUrls: ['./int07010101.component.css'],
  providers: [Int07010101Service]
})
export class Int07010101Component implements OnInit {
  ...
  constructor(
    ...
    private int07010101Service: Int07010101Service,
  ...
  backConfirm = () => {
    ...
    if (countTable > 0) {
      this.message.comfirm((res) => {
        if (res) {
          this.route.navigate(['/int07/01/01']);
        }
      }, "ยกเลิกการทำรายการ");
    }else{
      this.route.navigate(['/int07/01/01']);
  ...
  status = () => {
    this.int07010101Service.status().then((res) => {
