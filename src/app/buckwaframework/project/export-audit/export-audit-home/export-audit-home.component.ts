...
declare var $: any;
@Component({
  selector: 'app-export-audit-home',
  templateUrl: './export-audit-home.component.html',
  styleUrls: ['./export-audit-home.component.css'],
  providers: [TaxHomeService]
})
export class ExportAuditHomeComponent implements OnInit {
      ...
      columns: [
        {
          ...
          render: function (data, type, full, meta) {
            let _btn = '';
            _btn += `<button class="circular ui button" type="button" 
            >รายละเอียด</button>`;
            return _btn;
          },
          className: "center"
  ...
  async toSubPage(path: any) {
    this.router.navigate(['/export-audit-home/'+path]);
  }
