...
const URL = {
  SEARCH: AjaxService.CONTEXT_PATH + "ta/product-paper/list-product-paper-unit-price-reduce-tax",
  EXPORT: "ta/product-paper/export-product-paper-unit-price-reduce-tax"
}
