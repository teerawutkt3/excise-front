...
declare var $: any;
@Component({
  selector: "app-tan01-01",
  templateUrl: "./tan01-01.component.html",
  styleUrls: ["./tan01-01.component.css"]
})

export class Tan0101Component implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    //this.authService.reRenderVersionProgram('TAN-0101');
