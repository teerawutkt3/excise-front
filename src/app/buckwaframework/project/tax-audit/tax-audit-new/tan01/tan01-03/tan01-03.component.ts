...
declare var $: any;
@Component({
  selector: "app-tan01-03",
  templateUrl: "./tan01-03.component.html",
  styleUrls: ["./tan01-03.component.css"]
})

export class Tan0103Component implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    //this.authService.reRenderVersionProgram('TAN-0103');
