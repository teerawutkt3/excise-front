...
import { Ope0201001Vo, Ope020102Store } from './ope020102.model';

declare var $: any;

const URL = {
  // GET_FIND: AjaxService.CONTEXT_PATH + "oa/02/01/02/getLicenseCustomer",
  GET_FIND_CUS:AjaxService.CONTEXT_PATH +"oa/02/07/filter",
...
@Component({
  selector: 'app-ope020102',
  templateUrl: './ope020102.component.html',
  styleUrls: ['./ope020102.component.css']
})
export class Ope020102Component implements OnInit {
