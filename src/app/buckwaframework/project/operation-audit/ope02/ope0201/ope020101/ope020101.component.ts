...
@Component({
  selector: 'app-ope020101',
  templateUrl: './ope020101.component.html',
  styleUrls: ['./ope020101.component.css']
})
export class Ope020101Component implements OnInit {
  ...
  goEdit() {
    this.router.navigate(['/ope02/01/01/01/']);
  }
