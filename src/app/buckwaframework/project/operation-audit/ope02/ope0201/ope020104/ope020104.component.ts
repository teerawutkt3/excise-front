...
@Component({
  selector: 'app-ope020104',
  templateUrl: './ope020104.component.html',
  styleUrls: ['./ope020104.component.css']
})
export class Ope020104Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    $('#calendar').fullCalendar({
      ...
      events: [
        {
          title: 'บริษัท สมศักดิ์ ปิโตรเลียม โปรดักท์ จำกัด',
          description: 'บริษัท สมศักดิ์ ปิโตรเลียม โปรดักท์ จำกัด',
          start: '2562-02-15',
          end: '2562-02-15',
          status: "APPROVE",
        ...
        {
          title: 'ห้างหุ้นส่วนจำกัด องค์สนิทเฟลกโซฮอล์เฟลกโซลูปแอนด์ซัพพลาย',
          description: 'ห้างหุ้นส่วนจำกัด องค์สนิทเฟลกโซฮอล์เฟลกโซลูปแอนด์ซัพพลาย',
          start: '2562-02-15',
          end: '2562-02-15',
          status: "WAITING",
  ...
  prepare() {
    this.router.navigate(['/ope02/01/05/']);
  }

  checkout() {
    this.router.navigate(['/ope02/01/06/']);
  }
