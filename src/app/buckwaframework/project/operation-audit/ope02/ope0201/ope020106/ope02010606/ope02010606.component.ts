...
const URL = {
  GET_DETAILS: "oa/02/01/06/06/detail",
  PUT_UPDATE: "oa/02/01/06/06/save",
  GET_BUTTONS: "oa/02/01/06/detail",
  GET_FIND_CUSTOMER: "oa/02/01/06/customers",
}

@Component({
  selector: 'app-ope02010606',
  templateUrl: './ope02010606.component.html',
  styleUrls: ['./ope02010606.component.css']
})
export class Ope02010606Component implements OnInit {
  forms: FormGroup;
