...
const URL = {
  GET_DETAILS: "oa/02/01/06/02/detail",
  PUT_UPDATE: "oa/02/01/06/02/save",
  GET_BUTTONS: "oa/02/01/06/detail",
  GET_FIND_CUSTOMER: "oa/02/01/06/customers",
}

@Component({
  selector: 'app-ope02010602',
  templateUrl: './ope02010602.component.html',
  styleUrls: ['./ope02010602.component.css']
})
export class Ope02010602Component implements OnInit {
  ...
  getLubricantsDetail() {
    this.loading = true;
    this.ajax.doGet(`${URL.GET_DETAILS}/${this.lubrID}`).subscribe((response: ResponseData<Ope020106Vo>) => {
