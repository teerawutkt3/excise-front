...
const URL = {
     ...
     EXPORT_PDF: "oa/02/06/pdf",
     PUT_COMPLETE: "oa/02/01/06/complete/license"
}

@Component({
     selector: 'ope02010610',
     templateUrl: 'ope02010610.component.html',
     styleUrls: ['ope02010610.component.css']
})
export class Ope02010610Component {
     ...
     get frameUrl() {
          if (this.buttons) {
               console.log("s")
               return this.sanitizer.bypassSecurityTrustResourceUrl(AjaxService.CONTEXT_PATH + URL.EXPORT_PDF + "/" + this.buttons.oaCuslicenseId + "/" + this.buttons.oaLubricantsDtlId);
          } else {
