...
import { MessageService, AuthService } from 'services/index';
import { OaPlan, listOaPlan, planMonthVo } from './ope02.model';
...
import { Ope020103Store } from './ope0201/ope020103/ope020103.model';
import { Ope0201 } from './ope0201/ope0201Vo.model';
import { Ope020102Store } from './ope0201/ope020102/ope020102.model';

declare var $: any;

const URL = {
  GET_DETAILS: "oa/02/findPlan",
  PUT_UPDATE: "oa/02/01/save",
}

@Component({
  selector: 'app-ope02',
  templateUrl: './ope02.component.html',
  styleUrls: ['./ope02.component.css']
})

export class Ope02Component implements OnInit {
