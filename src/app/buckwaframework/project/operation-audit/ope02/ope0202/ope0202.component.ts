...
import { Ope0202, Ope0202Vo } from './ope0202vo.model';

declare var $: any;

const URL = {
  GET_FIND: "oa/02/02/findAll",
  PUT_STATUS: "oa/02/02/status"
}

@Component({
  selector: 'app-ope0202',
  templateUrl: './ope0202.component.html',
  styleUrls: ['./ope0202.component.css']
})
export class Ope0202Component implements OnInit {
