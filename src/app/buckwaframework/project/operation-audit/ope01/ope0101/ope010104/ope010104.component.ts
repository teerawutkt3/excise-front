...
@Component({
  selector: 'app-ope010104',
  templateUrl: './ope010104.component.html',
  styleUrls: ['./ope010104.component.css']
})
export class Ope010104Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    $('#calendar').fullCalendar({
      ...
      events: [
        {
          title: 'บริษัท เคทีซี เคมีคอล จำกัด',
          description: 'บริษัท เคทีซี เคมีคอล จำกัด',
          start: '2562-02-15',
          end: '2562-02-15',
          status: "APPROVE",
        ...
        {
          title: 'บริษัท อีสเทิร์นบอน',
          description: 'บริษัท อีสเทิร์นบอน',
          start: '2562-02-15',
          end: '2562-02-15',
          status: "WAITING",
  ...
  prepare() {
    this.router.navigate(['/ope01/01/05/']);
  }
