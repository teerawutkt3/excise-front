...
@Component({
  ...
  templateUrl: './ope010101.component.html',
  styleUrls: ['./ope010101.component.css']
})
export class Ope010101Component implements OnInit {
  ...
  goEdit() {
    this.router.navigate(['/ope01/01/01/01/']);
  }
