...
import { Ope020102Store } from 'projects/operation-audit/ope02/ope0201/ope020102/ope020102.model';

declare var $: any;

const URL = {
  // GET_FIND: AjaxService.CONTEXT_PATH + "oa/02/01/02/getLicenseCustomer",
  GET_FIND_CUS:AjaxService.CONTEXT_PATH +"oa/01/07/filter",
...
@Component({
  selector: 'app-ope010102',
  templateUrl: './ope010102.component.html',
  styleUrls: ['./ope010102.component.css']
})
export class Ope010102Component implements OnInit {
  ...
  dataTables1: any = [];
  tableData1: any;
  formData: Ope0101001Vo;
  dataStore: Observable<Ope010102Store>;
  ope020102Store: Ope010102Store;
  ope020102: Ope0101001Vo;
  sectors: Department[] = [];
  areas: Department[] = [];
  ...
  ngAfterViewInit() {
    ...
    this.ope020102Store.customerLicenseList.forEach(element => {
      ...
      this.dataSearchFrom.listID.push(wsId);
    });
    this.getSector();
    this.table1();
  ...
  clickTdButton() {
    this.tableData1.on("click", "button", e => {
      ...
      if (dataRow) {
        ...
        this.formData.licensePlanId = dataRow.licensePlanId;
