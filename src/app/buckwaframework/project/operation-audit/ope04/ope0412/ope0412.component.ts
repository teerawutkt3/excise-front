...
import { TypeOfCompany } from './ope0412.mock';
import { DateStringPipe } from 'app/buckwaframework/common/pipes';
import { TypeOfLicense } from 'projects/operation-audit/ope02/ope0207/ope0207.mock';
import { ROLES, AuthService } from 'services/auth.service';

declare var $: any;

const URL = {
  SEARCH: AjaxService.CONTEXT_PATH + "oa/04/12/filter",
  POST_SECTOR_LIST: "preferences/department/sector-list",
  POST_AREA_LIST: "preferences/department/area-list",
}

@Component({
  selector: 'app-ope0412',
  templateUrl: './ope0412.component.html',
  styleUrls: ['./ope0412.component.css']
})
export class Ope0412Component implements OnInit {
  breadcrumb: BreadCrumb[] = [
    { label: "ตรวจปฏิบัติการ", route: "#" },
    { label: "น้ำมันหล่อลื่น", route: "/ope02/" },
    { label: "ข้อมูลผู้ประกอบการสุรากลั่นชุมชน", route: "#" }
  ];
  offCode: string = "";
  dataTable: any = null;
  form: FormGroup = null;
