...
@Component({
  selector: 'app-ope041102',
  templateUrl: './ope041102.component.html',
  styleUrls: ['./ope041102.component.css']
})
export class Ope041102Component implements OnInit {

  breadcrumb: BreadCrumb[] = [
    { label: "ตรวจปฏิบัติการ", route: "#" },
    { label: "สุรากลั่นชุมชน", route: "#" },
    { label: "เลือกจากรายการแจ้งเตือน", route: "#" },
  ];
  dataTables1: any = [];
  dataTables2: any = [];
  ...
  goEdit() {
    this.router.navigate(['/ope04/11/02/01']);
  }

  goPlan() {
    this.router.navigate(['/ope04/11/']);
  }
