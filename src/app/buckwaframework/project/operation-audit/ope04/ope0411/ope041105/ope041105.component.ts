...
@Component({
  selector: 'app-ope041105',
  templateUrl: './ope041105.component.html',
  styleUrls: ['./ope041105.component.css']
})
export class Ope041105Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    $('#calendar').fullCalendar({
      ...
      events: [
        ...
        {
          title: 'หจก.ดวงจันทร์การสุรา',
          description: 'หจก.ดวงจันทร์การสุรา',
          start: '2562-02-18',
          end: '2562-02-18',
          status: "NEW"
        },
