...
@Component({
     selector: 'app-ope04010101',
     templateUrl: './ope04010101.component.html'
})
export class Ope04010101Component {
    ...
    // criteriaForm: FormGroup;
     ...
     goBack() {
          this.router.navigate(['/ope04/01/01/']);
     }

     goEdit() {
          this.router.navigate(['ope04/02/01/']);
     }
