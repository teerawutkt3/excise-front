...
import { ExciseService, MessageBarService, AjaxService, AuthService } from 'services/index';
...
@Component({
  selector: 'app-ope040103',
  templateUrl: './ope040103.component.html',
  styleUrls: ['./ope040103.component.css']
})
export class Ope040103Component implements OnInit {
