...
import { Ope0201, Ope0201FromVo, Ope0201Vo } from 'projects/operation-audit/ope02/ope0201/ope0201Vo.model';
...
const URL = {
  ...
  PUT_SAVE:"oa/04/01/save",
  PUT_UPDATE: "oa/04/01/update",
  GET_PLAN_DETAIL :"oa/04/01/findOaPlanACH",
  GET_APPROVER :"oa/04/01/findApprover",
  GET_SENDAPPROVE :"oa/04/01/sendApprove",
}

@Component({
  selector: 'app-ope0401',
  templateUrl: './ope0401.component.html',
  styleUrls: ['./ope0401.component.css']
})
export class Ope0401Component implements OnInit {
  ...
  gotoFindCustomer() {
    ...
    this.router.navigate(['/ope04/01/02'], {
      queryParams: {
        to: this.planStatus,
        planId:this.planId
      }
  ...
  gotoFindUserAudit() {
    ...
    this.router.navigate(['/ope04/01/03'], {
      queryParams: {
        to: this.planStatus,
        planId:this.planId
      }
